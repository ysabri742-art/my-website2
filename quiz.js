...
let allQuestions = [
    ...
    { id: 88, text: "عجلة نصف قطرها = 50سم وتدور 6 دورات، فكم المسافة التي تقطعها بالمتر؟", options: ["1884", "188,4", "18,84", "1,884"], answer: 2, marked: false, correct: 2 },

{ id: 89, text: "وزعت 32 قطعة كعك بالتساوي على 12 طفل، فكم عدد القطع المتبقية؟", options: ["8 قطع", "9 قطع", "10 قطع", "11 قطعة"], answer: 0, marked: false, correct: 0 },


    
    // الهندسة
    { id: 90, text: "في شكل شبه منحرف، أوجد س + ص (زاويتان خارجيتان).", options: ["230 درجة", "130 درجة", "270 درجة", "115 درجة"], answer: null, marked: false, correct: 0, header: "الهندسة" },
    { id: 91, text: "في الشكل المجاور أوجد طول أ ج: (أ ب = 7، ب د = 4، د ج = 4).", options: ["7", "8", "9", "10"], answer: null, marked: false, correct: 2 },
    { id: 92, text: "في شكل رباعي دائري، أوجد قيمة س (الزاوية المقابلة 80 درجة).", options: ["80 درجة", "100 درجة", "110 درجة", "120 درجة"], answer: null, marked: false, correct: 1 },
    { id: 93, text: "أحسب محيط الشكل التالي (مكون من مربعين أضلاعهما 3 و 4).", options: ["18", "20", "22", "24"], answer: null, marked: false, correct: 2 },
    { id: 94, text: "إذا كان طول ضلع المربع = 20 سم ورؤوسه مركز لأربع دوائر، أوجد مساحة المظلل (4 أرباع دائرة).", options: ["25 ط", "50 ط", "100 ط", "125 ط"], answer: null, marked: false, correct: 2 },
    { id: 95, text: "كم عدد المثلثات في الشكل (مستطيل داخله مربع مقسوم بقطرين).", options: ["8", "10", "12", "16"], answer: null, marked: false, correct: 3 },
    ...
    { id: 97, text: "أوجد مثلي س + ص (زاويتان حادتان في مثلث قائم).", options: ["60", "90", "120", "180"], answer: null, marked: false, correct: 3 },
    { id: 98, text: "ما قياس الزاوية س؟", options: ["60 درجة", "120 درجة", "140 درجة", "100 درجة"], answer: null, marked: false, correct: 1 },
    { id: 99, text: "ما نوع المثلث؟ (أضلاعه 4س، 3س، 2س).", options: ["مثلث قائم", "مثلث حاد", "مثلث متطابق الأضلاع", "مثلث منفرج"], answer: null, marked: false, correct: 3 },
    { id: 100, text: "ما متوسط الإيرادات للأعوام الأربعة؟ (8+12+10+16).", options: ["11.5", "12.5", "40", "46"], answer: null, marked: false, correct: 0 },
    
    // أسئلة المقارنة (تغطي باقي الأسئلة حتى 120)
    { id: 101, text: "كم عدد المستطيلات في الشكل (مستطيل مقسم إلى 5 أقسام طولية).", options: ["6", "15", "18", "24"], answer: null, marked: false, correct: 1, header: "أسئلة المقارنة" },
    { id: 102, text: "قارن بين: القيمة الأولى: 9 – 0.0044، القيمة الثانية: 9 – 0.00044", options: ["الأولى أكبر", "الثانية أكبر", "متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 1 },
    { id: 103, text: "قارن بين: القيمة الأولى: كمية العصير التي تملأ الإسطوانة القيمة الثانية: 750 مليلتر", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 0, marked: false, correct: 0 },

{ id: 104, text: "قارن بين: القيمة الأولى: 40% من 60 القيمة الثانية: 60 من 40%", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 2, marked: false, correct: 2 },

{ id: 105, text: "قارن بين: القيمة الأولى: مساحة المستطيل (طول = 6، عرض = 3) القيمة الثانية: مساحة المربع (ضلع = 5)", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 1, marked: false, correct: 1 },

{ id: 106, text: "قارن بين: القيمة الأولى: 35 القيمة الثانية: 28", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 0, marked: false, correct: 0 },

{ id: 107, text: "قارن بين: القيمة الأولى: مساحة المربع (ضلع = 6) القيمة الثانية: مساحة المثلث (قاعدة = 6، ارتفاع = 4)", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 0, marked: false, correct: 0 },

{ id: 108, text: "إذا كان س³ = 48 فقارن بين: القيمة الأولى: س² القيمة الثانية: 15", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 1, marked: false, correct: 1 },

{ id: 109, text: "إذا كانت 0 < ص < س فقارن بين: القيمة الأولى: س¹⁴³⁶ القيمة الثانية: ص²⁰¹⁵", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 0, marked: false, correct: 0 },

{ id: 110, text: "قارن بين: القيمة الأولى: مساحة الجزء (س) في الشكل القيمة الثانية: مساحة الجزء (ص)", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 2, marked: false, correct: 2 },

{ id: 111, text: "إذا كانت (م) نقطة مركز للمستطيل أ ب ج د فقارن بين: القيمة الأولى: عدد المستقيمات الممكن رسمها بين الرؤوس الأربعة القيمة الثانية: 6", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 2, marked: false, correct: 2 },

{ id: 112, text: "إذا كانت المسافة من س إلى ص = 12، والمسافات بينهم جميعًا متساوية فقارن بين: القيمة الأولى: 3 سم القيمة الثانية: ع ل (المسافة بين نقطتين متجاورتين)", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 1, marked: false, correct: 1 },

{ id: 113, text: "قارن بين: القيمة الأولى: محيط سداسي منتظم قطره = 8 القيمة الثانية: محيط دائرة قطرها = 8", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 1, marked: false, correct: 1 },

{ id: 114, text: "إذا كان 3 > س > 2 ، وص < س فقارن بين: القيمة الأولى: 0.75 القيمة الثانية: 0.5", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 1, marked: false, correct: 1 },

{ id: 115, text: "قارن بين: القيمة الأولى: عمر أحمد بالهجري القيمة الثانية: عمر أحمد بالميلادي", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 3, marked: false, correct: 3 },

{ id: 116, text: "الشكل التالي عبارة عن مستطيل فقارن بين: القيمة الأولى: نسبة الجزء المظلل إلى الشكل الكامل القيمة الثانية: 3 : 1", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 2, marked: false, correct: 2 },

{ id: 117, text: "قارن بين: القيمة الأولى: (7 + 6) ÷ (6 + 7) القيمة الثانية: (7 + 7) ÷ (7 + 8)", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 0, marked: false, correct: 0 },

{ id: 118, text: "قارن بين: القيمة الأولى: 100 القيمة الثانية: 10²", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 2, marked: false, correct: 2 },

{ id: 119, text: "إذا كان 0 < ص < س فقارن بين: القيمة الأولى: (س)²⁰¹⁶ القيمة الثانية: (ص)²⁰¹⁵", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 0, marked: false, correct: 0 },

{ id: 120, text: "قارن بين: القيمة الأولى: 50 القيمة الثانية: 45", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: 0, marked: false, correct: 0 },
