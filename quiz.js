...
{ id: 89, text: "وزعت 32 قطعة كعك بالتساوي على 12 طفل، فكم عدد القطع المتبقية؟", options: ["8 قطع", "9 قطع", "10 قطع", "11 قطعة"], answer: null, marked: false, correct: 0 },
    ...
    { id: 98, text: "ما قياس الزاوية س؟", options: ["60 درجة", "120 درجة", "140 درجة", "100 درجة"], answer: null, marked: false, correct: 1,imageURL: "https://raw.githubusercontent.com/ysabri742-art/my-website2/main/images/Picture9.png" },
    { id: 99, text: "ما نوع المثلث؟ .", options: ["مثلث قائم", "مثلث حاد", "مثلث متطابق الأضلاع", "مثلث منفرج"], answer: null, marked: false, correct: 3 ,imageURL: "https://raw.githubusercontent.com/ysabri742-art/my-website2/main/images/Picture10.png"},
    ...
    { id: 103, text: "قارن بين: القيمة الأولى: كمية العصير التي تملأ الإسطوانة القيمة الثانية: 750 مليلتر", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 0 ,imageURL: "https://raw.githubusercontent.com/ysabri742-art/my-website2/main/images/Picture13.png"},

{ id: 104, text: "قارن بين: القيمة الأولى: 40% من 60 القيمة الثانية: 60 من 40%", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 2},
...
{ id: 106, text: "قارن بين: القيمة الأولى: 35 القيمة الثانية: 28", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 0 },
...
{ id: 108, text: "إذا كان س³ = 48 فقارن بين: القيمة الأولى: س² القيمة الثانية: 15", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct:1 },

{ id: 109, text: "إذا كانت 0 > ص > س فقارن بين: القيمة الأولى: س¹⁴³⁶ القيمة الثانية: ص²⁰¹⁵", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 0 },
...
{ id: 113, text: "قارن بين: القيمة الأولى: محيط سداسي منتظم قطره = 8 القيمة الثانية: محيط دائرة قطرها = 8", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 1 },

{ id: 114, text: "إذا كان 3 < س < 5 ، وص > س فقارن بين: القيمة الأولى: 0.75 القيمة الثانية: 0.5", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 1 },

{ id: 115, text: "قارن بين: القيمة الأولى: عمر أحمد بالهجري القيمة الثانية: عمر أحمد بالميلادي", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 3 },
...
{ id: 117, text: "قارن بين: القيمة الأولى: (7 + 6) ÷ (6 + 7) القيمة الثانية: (7 + 7) ÷ (7 + 8)", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 0 },

{ id: 118, text: "قارن بين: القيمة الأولى: 100 القيمة الثانية: 10²", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 2 },

{ id: 119, text: "إذا كان 0 > ص > س فقارن بين: القيمة الأولى: (س)²⁰¹⁶ القيمة الثانية: (ص)²⁰¹⁵", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 0 },

{ id: 120, text: "قارن بين: القيمة الأولى: 50 القيمة الثانية: 45", options: ["القيمة الأولى أكبر من القيمة الثانية", "القيمة الثانية أكبر من القيمة الأولى", "القيمتان متساويتان", "المعطيات غير كافية"], answer: null, marked: false, correct: 0 },
