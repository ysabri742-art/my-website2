...
let allQuestions = [
    ...
    { id: 64, text: "ما وظيفة الكيروسين؟", options: ["لتوليد الكهرباء", "للإنارة والتدفئة والطهو", "لصناعة الطلاء", "لصناعة الطائرات"], answer: null, marked: false, correct: 1 },
    { id: 65, text: "لماذا يعد الوقود البترولي مميزًا عن الفحم؟", options: ["لأنه سائل", "لأنه رخيص", "احتراقه يكاد يكون كاملاً دون رماد", "لسهولة نقله فقط"], answer: null, marked: false, correct: 2 },
    { id: 66, text: "ماذا أحدث الوقود البترولي السائل في حياة البشر؟", options: ["تطور صناعة الفحم", "تغيرًا جذريًا", "صنع محركات الاحتراق الداخلي", "صعوبة في النقل"], answer: null, marked: false, correct: 1 },
    { id: 67, text: "من أول من صنع الأحذية؟", options: ["الرومان", "البريطانيون", "المصريون", "العرب"], answer: null, marked: false, correct: 2 },
    { id: 68, text: "ما هي المادة التي كان يستخدمها المصريون في صناعة الأحذية؟", options: ["الجلد أو ورق البردي", "المطاط", "الخشب", "النحاس"], answer: null, marked: false, correct: 0 },
    { id: 69, text: "لماذا كان المصريون يرفعون مقدمة الصندل للأعلى؟", options: ["للتزيين", "لحماية إبهام القدمين", "لمواكبة الموضة", "لجعله يتلف بسرعة"], answer: null, marked: false, correct: 1 },
    ...
    { id: 75, text: "ما أهمية الإسفلت؟", options: ["يستخدم للإنارة", "يستخدم في صناعة الأحذية الرياضية", "يستخدم لطلاء المنازل", "يستخدم كوقود"], answer: null, marked: false, correct: 1 },
    { id: 76, text: "لماذا لم يكن الإنسان ينتفع بالزيت على نطاق واسع في الماضي؟", options: ["لعدم وجود طلب", "لافتقاره للأساليب الاقتصادية للاستخراج", "لأن الزيت كان يتلف بسرعة", "لأن الزيت كان قليلاً"], answer: null, marked: false, correct: 1 },
    { id: 77, text: "ما الفرق بين النمو والتنمية؟", options: ["النمو تطوير والتنمية تغير مادي", "كلاهما مترادفان", "النمو تغير مادي والتنمية تطوير", "النمو مادي فقط والتنمية غير مادية فقط"], answer: null, marked: false, correct: 2 },
    { id: 78, text: "ما العلاقة بين النمو والتنمية؟", options: ["كلاهما لا يؤثر في الآخر", "كلاهما يعتمد على الآخر لوصف النجاح", "النمو أهم من التنمية", "التنمية أهم من النمو"], answer: null, marked: false, correct: 1 },
    { id: 79, text: "ما الذي يشكل الجزء الأكبر في حياتنا لحدوث التغيير المصاحب للتنمية؟", options: ["التوسع الاجتماعي", "التوسع الاقتصادي", "التوسع العمراني", "التوسع الثقافي"], answer: null, marked: false, correct: 1 },
    { id: 80, text: "متى يحدث النمو والتنمية معًا؟", options: ["بتحديد الأهداف وإنجازها بوجود الإرادة", "عندما يسبق النمو التنمية", "عندما تسبق التنمية النمو", "عندما لا يحدث أي منهما"], answer: null, marked: false, correct: 0 },
    { id: 81, text: "ما الضرر الذي تسببه الأحذية الخشبية؟", options: ["ثقيلة وتسبب التزحلق", "قصيرة العمر وتتمزق", "صعبة اللبس", "غالية الثمن"], answer: null, marked: false, correct: 0 },
    { id: 82, text: "لماذا كان البنزين لا يكاد يفي بالطلب المتزايد عليه؟", options: ["لقلة الطلب", "لأنه ينتج عن الزيت الخام", "لأن نسبة البنزين في الزيت الخام ضئيلة", "لأنه مادة عازلة"], answer: null, marked: false, correct: 2 },
    { id: 83, text: "العلاقة بين 'النمو' و 'التغير في الجوانب المادية':", options: ["تضاد", "ترادف", "تعريف", "سبب ونتيجة"], answer: null, marked: false, correct: 2 },
    { id: 84, text: "العبارة 'من شغل نفسه بعيوب غيره كثرت عيوبه' تعني:", options: ["الذي يركز على عيوب الناس يزيد من عيوبه", "الذي يرى عيوبه يقلل منها", "الذي يركز على عيوب الناس لا يهتم بعيوبه", "كل ما سبق"], answer: null, marked: false, correct: 0 },
    { id: 85, text: "تستطيع حشرة السمك التغذي على أغلفة الكتب لأنها:", options: ["مصنوعة من القماش", "مصنوعة من الورق", "تحتوي على السكريات", "غير نظيفة"], answer: null, marked: false, correct: 1 },
    { id: 86, text: "ما الفرق الرئيسي في شكل طفح الجدري والجديري؟", options: ["اللون", "الحجم", "مكان الظهور ووقت التحول", "مدة العلاج"], answer: null, marked: false, correct: 2 },
    { id: 87, text: "أوجد قيمة المقدار: (1/3) + (1/2 * 1/3) – (1/6) - (1/3)", options: ["1/6", "0", "2", "3"], answer: null, marked: false, correct: 1, header: "الجبر والحساب" },
    { id: 88, text: "بطاقات مرقمة من 1 إلى 99، فما احتمال سحب بطاقة مجموع رقميها أكبر من 11؟", options: ["10/99", "11/99", "27/99", "28/99"], answer: null, marked: false, correct: 3 },
    { id: 89, text: "10^6 – 1 = .....", options: ["99800", "998000", "999999", "980000"], answer: null, marked: false, correct: 2 },
    { id: 90, text: "كم مرة يتكرر الرقم ٩ من ١ الى ١٠٠؟", options: ["19", "20", "21", "22"], answer: null, marked: false, correct: 1 },
    { id: 91, text: "ما قيمة المقدار تقريباً: 10 / (جذر 30 * جذر 10)", options: ["1/جذر3", "1/3", "1/10", "1/30"], answer: null, marked: false, correct: 0 },
    { id: 92, text: "ما نصف العدد 2^50", options: ["2^62", "2^52", "2^49", "2^51"], answer: null, marked: false, correct: 2 },
    { id: 93, text: "إذا كان 2^ن + 2^ن + 2^ن + 2^ن = 8^2 فما قيمة ن؟", options: ["2", "8", "4", "6"], answer: null, marked: false, correct: 2 },
    ...
    { id: 99, text: "إذا كان (أ - ب = ٥)، (ب - ج = ٣)، (ج + د = ١)، أوجد أ + د", options: ["1", "8", "9", "4"], answer: null, marked: false, correct: 2 },
    { id: 100, text: "أوجد قيمة المقدار: (2^7 + 2^7) / (2^7 + 2^7 + 2^7 + 2^7)", options: ["1/4", "1/2", "1/8", "1/16"], answer: null, marked: false, correct: 1 },
    
    // المسائل المقالية
    { id: 101, text: "نريد توزيع 64 حاسب و 48 طابعة على عدد من الغرف. فما أكبر عدد من هذه الغرف؟", options: ["8 غرف", "12 غرفة", "16 غرفة", "24 غرفة"], answer: null, marked: false, correct: 2, header: "الأسئلة المقالية" },
    { id: 102, text: "زادت أرباح شركة بقدار 10% كل سنة خلال 3 سنوات. فما إجمالي الأرباح بعد السنة الثالثة؟", options: ["25%", "33.1%", "35%", "30%"], answer: null, marked: false, correct: 1 },
    { id: 103, text: "أب عمره 71، وابن عمره 35، فبعد كم سنة يصبح عمر الأب مثلي عمر الابن؟", options: ["سنة", "سنتين", "8 سنين", "4 سنين"], answer: null, marked: false, correct: 0 },
    { id: 104, text: "سفينة تحمل 20 صندوق كبير أو 24 صندوق صغير. إذا حملت 15 كبير، كم صغير يمكن أن تحمل؟", options: ["4 صناديق", "6 صناديق", "8 صناديق", "10 صناديق"], answer: null, marked: false, correct: 1 },
    { id: 105, text: "مستطيل 300 × 100 سم، الورقة 30 × 20 سم. كم عدد الأوراق؟", options: ["50 ورقة", "75 ورقة", "100 ورقة", "150 ورقة"], answer: null, marked: false, correct: 0 },
    { id: 106, text: "دفع أحمد 45% وفهد 25%، وتبقى 360000 ريال. فما تكلفة بناء المسجد كاملة؟", options: ["1200000 ريال", "1400000 ريال", "2400000 ريال", "1000000 ريال"], answer: null, marked: false, correct: 0 },
